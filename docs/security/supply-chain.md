...
gh release download v0.1.10 -R fabriziosalmi/zion \
    -p 'zion-v0.1.10-x86_64-unknown-linux-musl.tar.gz' \
    -p 'SHA256SUMS' \
...
gh attestation verify zion-v0.1.10-x86_64-unknown-linux-musl.tar.gz \
    --owner fabriziosalmi
...
```bash
IMAGE=ghcr.io/fabriziosalmi/zion:v0.1.10
