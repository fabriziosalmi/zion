...
44 modules, ~36,000 lines of Rust. See [architecture docs](https://fabriziosalmi.github.io/zion/guide/architecture) for the full module map and request lifecycle.
...
**763 unit tests** run on every change; **23 integration tests** need a running Zion + a backend.
