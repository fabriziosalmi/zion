...
42 modules, ~30,500 lines of Rust. See [architecture docs](https://fabriziosalmi.github.io/zion/guide/architecture) for the full module map and request lifecycle.
...
```bash
# Unit tests (656) <!-- zion-stats:test-count (kept in sync by scripts/update-readme-stats.sh) -->
cargo test
